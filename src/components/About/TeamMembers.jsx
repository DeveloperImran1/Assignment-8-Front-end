  ...
  return (
    <div className="container mx-auto p-4  bg-white">
      <SectionTitleSimple
        ...
        subtitle="Our team is dedicated, passionate, and skilled, committed to delivering exceptional results. We believe in collaboration, innovation, and striving for excellence in everything we do."
      />
